...
<body class="bg-slate-50 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-2xl shadow-xl border border-slate-100">
        ...
        <form class="mt-8 space-y-5" action="<?php echo e(route('login.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="login_field" name="login_field" type="text" required 
                            ...
                            placeholder="Nhập email, sđt hoặc username..." value="<?php echo e(old('login_field')); ?>">
                    </div>
...
<?php /**PATH C:\Users\danht\OneDrive\Desktop\toi_uu_giao_van\resources\views/auth/login.blade.php ENDPATH**/ ?>