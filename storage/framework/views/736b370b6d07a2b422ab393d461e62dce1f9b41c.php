...
<?php $__env->startSection('header_title', 'Hệ Thống Điều Phối Thông Minh'); ?>
...
<div class="flex items-center justify-between mb-4 flex-wrap gap-2">
    ...
    <div class="flex items-center gap-2">
        ...
        <a href="<?php echo e(route('admin.routes')); ?>" class="inline-flex items-center px-3 py-2 rounded-xl text-xs font-bold bg-slate-100 text-slate-600 border border-slate-200 hover:bg-slate-200 transition shadow-sm">
...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-4 text-white shadow-lg">
        ...
        <p class="text-3xl font-extrabold mt-1"><?php echo e($stats['unassigned']); ?></p>
    ...
    <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-4 text-white shadow-lg">
        ...
        <p class="text-3xl font-extrabold mt-1"><?php echo e($stats['active_shippers']); ?></p>
    ...
    <div class="bg-gradient-to-br from-violet-500 to-violet-600 rounded-2xl p-4 text-white shadow-lg">
        ...
        <p class="text-3xl font-extrabold mt-1"><?php echo e($stats['active_routes']); ?></p>
    ...
    <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-4 text-white shadow-lg">
        ...
        <p class="text-3xl font-extrabold mt-1"><?php echo e($stats['total_processing']); ?></p>
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden">
        ...
        <div class="p-5 space-y-4">
            ...
            <form action="<?php echo e(route('admin.dispatch.batch')); ?>" method="POST" class="space-y-3" id="batchForm">
                <?php echo csrf_field(); ?>
            ...
            <div class="border-t border-slate-100 pt-3">
                <p class="text-[10px] font-bold text-slate-400 uppercase mb-2">Đơn chưa gán (<?php echo e($unassignedOrders->count()); ?>)</p>
                <div class="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                    <?php $__empty_1 = true; $__currentLoopData = $unassignedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between bg-slate-50 rounded-lg px-2.5 py-1.5 text-[11px]">
                        <span class="font-bold text-blue-600"><?php echo e($order->order_code); ?></span>
                        <span class="text-slate-400 truncate mx-2 flex-1"><?php echo e(Str::limit($order->delivery_address, 25)); ?></span>
                        <span class="text-[9px] text-slate-300 font-mono"><?php echo e(number_format($order->delivery_lat,4)); ?>,<?php echo e(number_format($order->delivery_lng,4)); ?></span>
                    </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden">
            ...
            <div class="p-5">
                <div class="space-y-2 max-h-48 overflow-y-auto">
                    ...
                    <div class="border border-slate-200 rounded-xl px-3 py-2.5 text-xs" id="route-card-<?php echo e($route->id); ?>">
                        <div class="flex items-center justify-between mb-1.5">
                            <div>
                                <span class="font-bold text-slate-800">Tuyến #<?php echo e($route->id); ?></span>
                                <span class="text-slate-400 ml-2" id="route-stats-<?php echo e($route->id); ?>"><?php echo e($route->routeOrders->count()); ?> điểm · <span class="route-dist-val"><?php echo e($route->total_distance); ?></span> km</span>
                            </div>
                            <form action="<?php echo e(route('admin.dispatch.optimize', $route->id)); ?>" method="POST" onsubmit="handleOptimize(event, <?php echo e($route->id); ?>, this)">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="inline-flex items-center gap-1 px-2.5 py-1 bg-violet-600 hover:bg-violet-700 text-white text-[10px] font-bold rounded-lg transition" <?php echo e($route->routeOrders->count() < 2 ? 'disabled' : ''); ?>>
                        ...
                        <div class="text-[10px] text-slate-400">
                            Shipper: <span class="font-semibold text-slate-600"><?php echo e($route->shipper->user->username ?? 'Chưa gán'); ?></span>
                            · Ước tính: <span class="route-time-val"><?php echo e($route->estimated_time); ?></span> phút
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden">
            ...
            <div class="p-5">
                ...
                <div class="space-y-2 mb-4">
                    <?php $__empty_1 = true; $__currentLoopData = $activeShippers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="auto-assign-shipper-item flex items-center justify-between bg-emerald-50 border border-emerald-100 rounded-lg px-3 py-2 text-xs" data-region="<?php echo e($s->region ?? '10.7769,106.7009'); ?>">
                        <div class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                            <span class="font-bold text-slate-800"><?php echo e($s->user->username ?? 'N/A'); ?></span>
                            <span class="text-slate-400"><?php echo e($s->vehicle_type); ?></span>
                        </div>
                        <span class="bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded text-[10px] font-bold"><?php echo e($s->active_order_count); ?> đơn</span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <form action="<?php echo e(route('admin.dispatch.auto-assign')); ?>" method="POST" id="autoAssignForm">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                        <label class="block text-[10px] font-bold text-slate-400 uppercase mb-2">Chọn tuyến chưa gán Shipper:</label>
                        <div class="space-y-1.5 max-h-36 overflow-y-auto">
                            <?php $__currentLoopData = $routes->where('shipper_id', null); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <label class="auto-assign-route-item flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 cursor-pointer hover:border-emerald-300" 
                                data-lat="<?php echo e(optional(optional(optional($route->routeOrders->first())->order)->hub)->latitude ?? optional(optional($route->routeOrders->first())->order)->pickup_lat ?? '10.7769'); ?>" 
                                data-lng="<?php echo e(optional(optional(optional($route->routeOrders->first())->order)->hub)->longitude ?? optional(optional($route->routeOrders->first())->order)->pickup_lng ?? '106.7009'); ?>">
                                <input type="checkbox" name="route_ids[]" value="<?php echo e($route->id); ?>" class="rounded text-emerald-600" checked>
                                <span class="text-xs font-bold text-slate-700">Tuyến #<?php echo e($route->id); ?></span>
                                <span class="text-[10px] text-slate-400"><?php echo e($route->routeOrders->count()); ?> điểm</span>
                                <span class="ml-auto text-[10px] text-slate-400"><?php echo e($route->total_distance); ?> km</span>
                            </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($routes->where('shipper_id', null)->isEmpty()): ?>
                            <p class="text-xs text-slate-400 text-center py-2">Không có tuyến nào chưa gán</p>
                            <?php endif; ?>
                        </div>
                    </div>
                    <button type="submit" class="w-full py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition shadow-sm flex items-center justify-center gap-1.5" <?php echo e($routes->where('shipper_id', null)->isEmpty() ? 'disabled' : ''); ?>>
...
const unassignedOrders = <?php echo json_encode($unassignedOrders->map(fn($o) => [
    'id' => $o->id, 'code' => $o->order_code,
    'lat' => (float)$o->delivery_lat, 'lng' => (float)$o->delivery_lng,
    'address' => $o->delivery_address,
])->values()); ?>;

const routes = <?php echo json_encode($routes->map(function($r) {
...
function loadCompareShippers() {
    ...
    fetch(`<?php echo e(route("admin.dispatch.compare-shippers")); ?>?lat=${lat}&lng=${lng}`)
        .then(r => r.json())
        .then(data => {
            if(!data.success) {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\danht\OneDrive\Desktop\toi_uu_giao_van\resources\views/admin/dispatch.blade.php ENDPATH**/ ?>