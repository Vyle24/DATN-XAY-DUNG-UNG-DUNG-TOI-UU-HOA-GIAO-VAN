<?php $__env->startSection('header_title', 'Đặt Đơn Hàng Mới'); ?>
...
<div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div class="lg:col-span-5 bg-white rounded-2xl border border-slate-200/60 shadow-sm p-5 md:p-6 flex flex-col justify-between">
        <form action="<?php echo e(route('customer.orders.store')); ?>" method="POST" id="orderForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="hub_id" id="hub_id" class="w-full rounded-xl border-slate-250/80 bg-slate-50/50 px-3 py-2 text-xs font-semibold focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" required>
                        ...
                        <option value="<?php echo e($hub->id); ?>" 
                                data-address="<?php echo e($hub->address); ?>" 
                                data-lat="<?php echo e($hub->latitude); ?>" 
                                data-lng="<?php echo e($hub->longitude); ?>">
                            <?php echo e($hub->name); ?> (<?php echo e($hub->address); ?>)
                        </option>
                ...
                <div class="hidden">
                    ...
                    <select id="district_rate" name="district_rate_id" class="w-full rounded-xl border-slate-250/80 bg-slate-50/50 px-3 py-2 text-xs font-semibold focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition" required>
                        ...
                        <option value="<?php echo e($rate->id); ?>" 
                                data-base="<?php echo e($rate->base_price); ?>" 
                                data-perkm="<?php echo e($rate->price_per_km); ?>">
                            <?php echo e($rate->district_name); ?> (Cơ bản: <?php echo e(number_format($rate->base_price)); ?>đ + <?php echo e(number_format($rate->price_per_km)); ?>đ/km)
                        </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<script>
    ...
    const baseWeightLimit = <?php echo e($baseWeightLimit); ?>;
    const pricePerKg = <?php echo e($pricePerKg); ?>;
    ...
    function verifyVoucher() {
        ...
        fetch("<?php echo e(route('customer.vouchers.apply')); ?>", {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\danht\OneDrive\Desktop\toi_uu_giao_van\resources\views/customer/create_order.blade.php ENDPATH**/ ?>